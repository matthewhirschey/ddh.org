...
ggplot() +
  ...
  labs(x = "Dependency Score", y = "Count", title = paste0("Dependency Score Distribution from ", params$release)) +
  theme_cowplot()
```
...
##Patterns##
To find patterns in gene dependencies across cell lines, we generated a Pearson correlation matrix of all genes by all genes. These data generated correlation values that matched values published on [depmap.org](https://depmap.org), validating the first step in our analysis.  
