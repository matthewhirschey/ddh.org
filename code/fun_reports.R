...
make_summary <- function(gene_symbol, content) {
  if(content == "gene"){
...
make_summary(gene_symbol = "SDHA", content = "gene")

render_complete_report <- function (file, gene_symbol, content) {
  summary <- make_summary(gene_symbol, content)
...
render_dummy_report <- function (file, gene_symbol, content) {
  summary <- make_summary(gene_symbol, content)
