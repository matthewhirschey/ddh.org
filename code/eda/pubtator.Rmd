...
#rm(list = ls())
```
PubTator is a ML-model to extract "concepts" from 30M abstracts and 3M full-length papers
...
disease2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/disease2pubtatorcentral.sample"
disease2pubtator_sample <- read_tsv(disease2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))

chemical2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/chemical2pubtatorcentral.sample"
chemical2pubtator_sample <- read_tsv(chemical2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))

# not helpful
# species2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/species2pubtatorcentral.sample"
# species2pubtator_sample <- read_tsv(species2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))

# could be interesting for some EDA
mutation2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/mutation2pubtatorcentral.sample"
mutation2pubtator_sample <- read_tsv(mutation2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))

# uses cellosaurus for cell line ids e.g. CVCL_0030 is HeLa
# get cellosaurus data here: https://ftp.expasy.org/databases/cellosaurus/
cellline2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/cellline2pubtatorcentral.sample"
cellline2pubtator_sample <- read_tsv(cellline2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))

# ALL DATA; need to filter on type 4GB file
# 1 Chemical 1.13GB
# 2 Disease 1.47 GB
# 3 Species 434 MB
# 4 Gene 563 MB
# 5 Mutation 4.3 MB  
# 6 CellLine 19.8 MB    
bioconcepts2pubmedurl_sample <- "ftp://ftp.ncbi.nlm.nih.gov/pub/lu/PubTatorCentral/bioconcepts2pubtatorcentral.sample"
bioconcepts2pubtator_sample <- read_tsv(bioconcepts2pubmedurl_sample, col_names = c("pmid", "type", "concept_id", "mentions", "resource"))
