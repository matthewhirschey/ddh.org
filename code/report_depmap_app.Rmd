...
knitr::kable(head(target_achilles_bottom, n = 10), col.names = c("Cell Line", "Lineage", "Dep Score"))
```
    
### Cells that don't rely on `r gene_symbol` or if greater than 1 gain fitness when `r gene_symbol` is knocked out
```{r, echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(head(target_achilles_top, n = 10), col.names = c("Cell Line", "Lineage", "Dep Score"))
```
